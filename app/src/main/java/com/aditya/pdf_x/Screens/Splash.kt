...
fun Splash(navController: NavHostController) {
    ...
    val brush=Brush.linearGradient(listOf(Color.Black,Color.Blue.copy(alpha = 0.8f),Color.Black))
    Column (modifier = Modifier.fillMaxSize()
        ...
        AnimatedVisibility(true,
            ...
            Image(painter = painterResource(R.drawable.lofo), contentDescription = null,
